  ...
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto pb-24">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-slate-900">Order Wallet Report</h1>
          <p className="text-slate-500 mt-1">Monitor order wallet transactions and balances</p>
        </div>
        <div className="flex items-center gap-2">
          <Button variant="outline" onClick={handleDownloadCsv} className="bg-white" disabled={isLoading}>
            <FileText className="mr-2 h-4 w-4" />
            CSV Export
          </Button>
          <Button variant="outline" onClick={handleDownloadExcel} className="bg-white" disabled={isLoading}>
          ...
          <Card className="mb-6 shadow-sm border-slate-200">
            <CardContent className="p-4">
              <div className="flex flex-col lg:flex-row lg:items-end gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Popover open={isEndDatePickerOpen} onOpenChange={setIsEndDatePickerOpen}>
                      <PopoverTrigger asChild>
                        <Button
                          variant={"outline"}
                          className={cn("w-full justify-start text-left font-normal bg-white", !endDate && "text-muted-foreground")}
                        >
                          <CalendarIcon className="mr-2 h-4 w-4 text-slate-400" />
                ...
                <Button variant="ghost" onClick={resetFilters} className="text-slate-500 hover:text-slate-900 mt-2 lg:mt-0">
                  Reset Filters
                </Button>
              </div>
            </CardContent>
